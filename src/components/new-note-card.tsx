...
export function NewNoteCard({ onNoteCreated }: NewNoteCardProps) {
  ...
  return (
    <Dialog.Root>
      ...
      <Dialog.Portal>
        <Dialog.Overlay className="0 fixed inset-0 bg-black/50" />
          ...
          <form className="flex flex-1 flex-col">
            ...
            {isRecording ? (
              <button
                ...
                className="flex-center flex w-full items-center justify-center gap-2 bg-slate-900 py-4 text-center text-sm font-medium text-slate-300 outline-none hover:text-slate-100"
              >
